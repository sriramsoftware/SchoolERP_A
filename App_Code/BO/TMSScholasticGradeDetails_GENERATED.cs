...
public partial class TMSScholasticGradeDetails
{
	...
	#region Constants
	private static readonly string TABLE_NAME = "[dbo].[TMS_ScholasticGradeDetails]";
	...
	public static TMSScholasticGradeDetails[] MapFrom(DataSet ds)
	{
		List<TMSScholasticGradeDetails> objects;
		
		
		// Initialise Collection.
		objects = new List<TMSScholasticGradeDetails>();
		...
		if (ds.Tables[TABLE_NAME] == null)
		throw new ApplicationException("Cannot find table [dbo].[TMS_ScholasticGradeDetails] in DataSet.");
		
		if (ds.Tables[TABLE_NAME].Rows.Count < 1)
		throw new ApplicationException("Table [dbo].[TMS_ScholasticGradeDetails] is empty.");
		
		// Map DataSet to Instance.
		foreach (DataRow dr in ds.Tables[TABLE_NAME].Rows)
		{
			TMSScholasticGradeDetails instance = new TMSScholasticGradeDetails();
			instance.MapFrom(dr);
	...
	public static TMSScholasticGradeDetails Get(System.Int64 sgpGradeId)
	{
		DataSet ds;
		Database db;
		string sqlCommand;
		DbCommand dbCommand;
		TMSScholasticGradeDetails instance;
		
		
		instance = new TMSScholasticGradeDetails();
		
		db = DatabaseFactory.CreateDatabase();
		sqlCommand = "[dbo].gspTMSScholasticGradeDetails_SELECT";
		dbCommand = db.GetStoredProcCommand(sqlCommand, sgpGradeId);
		
		// Get results.
		ds = db.ExecuteDataSet(dbCommand);
		// Verification.
        if (ds == null || ds.Tables[0].Rows.Count == 0) //throw new ApplicationException("Could not get TMSScholasticGradeDetails ID:" + sgpGradeId.ToString()+ " from Database.");
            // Return results.
            return null;
	...
	public void Insert(System.String sgpGradeName, System.Int32? sgpGradePoint, System.DateTime? sgpDate, System.Int32? sgpStatus, DbTransaction transaction)
	{
		...
		db = DatabaseFactory.CreateDatabase();
		sqlCommand = "[dbo].gspTMSScholasticGradeDetails_INSERT";
	...
	/// <summary>
	/// Insert current TMSScholasticGradeDetails to database.
	/// </summary>
	...
	public static void Update(System.Int64? sgpGradeId, System.String sgpGradeName, System.Int32? sgpGradePoint, System.DateTime? sgpDate, System.Int32? sgpStatus, DbTransaction transaction)
	{
		...
		db = DatabaseFactory.CreateDatabase();
		sqlCommand = "[dbo].gspTMSScholasticGradeDetails_UPDATE";
	...
	public static void Update(TMSScholasticGradeDetails tMSScholasticGradeDetails)
	{
		tMSScholasticGradeDetails.Update();
	}
	
	public static void Update(TMSScholasticGradeDetails tMSScholasticGradeDetails, DbTransaction transaction)
	{
		tMSScholasticGradeDetails.Update(transaction);
	}
	...
	public static void Delete(System.Int64? sgpGradeId, DbTransaction transaction)
	{
		...
		db = DatabaseFactory.CreateDatabase();
		sqlCommand = "[dbo].gspTMSScholasticGradeDetails_DELETE";
		dbCommand = db.GetStoredProcCommand(sqlCommand, sgpGradeId);
	...
	/// <summary>
	/// Delete current TMSScholasticGradeDetails from database.
	/// </summary>
	/// <param name="transaction">optional SQL Transaction</param>
	...
	#region SEARCH
	[DataObjectMethodAttribute(DataObjectMethodType.Select, false)]
	public static TMSScholasticGradeDetails[] Search(System.Int64? sgpGradeId, System.String sgpGradeName, System.Int32? sgpGradePoint, System.DateTime? sgpDate, System.Int32? sgpStatus)
	{
		DataSet ds;
		Database db;
		string sqlCommand;
		...
		ds = db.ExecuteDataSet(dbCommand);
		ds.Tables[0].TableName = TABLE_NAME;
		return TMSScholasticGradeDetails.MapFrom(ds);
	}
	
	
	public static TMSScholasticGradeDetails[] Search(TMSScholasticGradeDetails searchObject)
	{
	...
	public static TMSScholasticGradeDetails[] Search()
	{
