...
/*                                                                          */
/* Date Generated: 10/31/2012 12:17:02 PM                                    */
/*                                                                          */
/* www.CodeAuthor.org                                                       */
/****************************************************************************/
using System;
...
public partial class TMSSkillType
{
	...
	{
		List<TMSSkillType> objects;
		
		
		// Initialise Collection.
		objects = new List<TMSSkillType>();
		...
		{
			TMSSkillType instance = new TMSSkillType();
			instance.MapFrom(dr);
	...
	public static TMSSkillType Get(System.Int64 stSkillId)
	{
		DataSet ds;
		Database db;
		string sqlCommand;
		DbCommand dbCommand;
		TMSSkillType instance;
		
		
		instance = new TMSSkillType();
		
		db = DatabaseFactory.CreateDatabase();
		sqlCommand = "[dbo].gspTMSSkillType_SELECT";
		dbCommand = db.GetStoredProcCommand(sqlCommand, stSkillId);
		
		// Get results.
		ds = db.ExecuteDataSet(dbCommand);
		// Verification.
		if (ds == null || ds.Tables[0].Rows.Count == 0) throw new ApplicationException("Could not get TMSSkillType ID:" + stSkillId.ToString()+ " from Database.");
		// Return results.
	...
	public void Insert(System.Int64? stSchoolId, System.String stSkillName, System.String stSkillDescription, System.String stExtra, System.DateTime? stDate, System.Int32? stStatus, DbTransaction transaction)
	{
		...
		db = DatabaseFactory.CreateDatabase();
		sqlCommand = "[dbo].gspTMSSkillType_INSERT";
	...
	/// <summary>
	/// Insert current TMSSkillType to database.
	/// </summary>
	...
	public static void Update(System.Int64? stSkillId, System.Int64? stSchoolId, System.String stSkillName, System.String stSkillDescription, System.String stExtra, System.DateTime? stDate, System.Int32? stStatus, DbTransaction transaction)
	{
		...
		db = DatabaseFactory.CreateDatabase();
		sqlCommand = "[dbo].gspTMSSkillType_UPDATE";
	...
	public static void Update(TMSSkillType tMSSkillType)
	{
		tMSSkillType.Update();
	}
	
	public static void Update(TMSSkillType tMSSkillType, DbTransaction transaction)
	{
		tMSSkillType.Update(transaction);
	}
	...
	public static void Delete(System.Int64? stSkillId, DbTransaction transaction)
	{
		...
		db = DatabaseFactory.CreateDatabase();
		sqlCommand = "[dbo].gspTMSSkillType_DELETE";
		dbCommand = db.GetStoredProcCommand(sqlCommand, stSkillId);
	...
	/// <summary>
	/// Delete current TMSSkillType from database.
	/// </summary>
	/// <param name="transaction">optional SQL Transaction</param>
	...
	#region SEARCH
	[DataObjectMethodAttribute(DataObjectMethodType.Select, false)]
	public static TMSSkillType[] Search(System.Int64? stSkillId, System.Int64? stSchoolId, System.String stSkillName, System.String stSkillDescription, System.String stExtra, System.DateTime? stDate, System.Int32? stStatus)
	{
		DataSet ds;
		Database db;
		string sqlCommand;
		...
		ds = db.ExecuteDataSet(dbCommand);
		ds.Tables[0].TableName = TABLE_NAME;
		return TMSSkillType.MapFrom(ds);
	}
	
	
	public static TMSSkillType[] Search(TMSSkillType searchObject)
	{
	...
	/// <summary>
	/// Returns all TMSSkillType objects.
	/// </summary>
	/// <returns>List of all TMSSkillType objects. </returns>
	[DataObjectMethodAttribute(DataObjectMethodType.Select, true)]
	public static TMSSkillType[] Search()
	{
