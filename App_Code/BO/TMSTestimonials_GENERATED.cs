...
/*                                                                          */
/* Date Generated: 5/26/2012 3:10:20 PM                                    */
/*                                                                          */
/* www.CodeAuthor.org                                                       */
/****************************************************************************/
using System;
...
public partial class TMSTestimonials
{
	...
	#region Constants
	private static readonly string TABLE_NAME = "[dbo].[TMS_Testimonials]";
	...
	public static TMSTestimonials[] MapFrom(DataSet ds)
	{
		List<TMSTestimonials> objects;
		
		
		// Initialise Collection.
		objects = new List<TMSTestimonials>();
		...
		if (ds.Tables[TABLE_NAME] == null)
		throw new ApplicationException("Cannot find table [dbo].[TMS_Testimonials] in DataSet.");
		
		if (ds.Tables[TABLE_NAME].Rows.Count < 1)
		throw new ApplicationException("Table [dbo].[TMS_Testimonials] is empty.");
		
		// Map DataSet to Instance.
		foreach (DataRow dr in ds.Tables[TABLE_NAME].Rows)
		{
			TMSTestimonials instance = new TMSTestimonials();
			instance.MapFrom(dr);
	...
	public static TMSTestimonials Get(System.Int64 tsId)
	{
		DataSet ds;
		Database db;
		string sqlCommand;
		DbCommand dbCommand;
		TMSTestimonials instance;
		
		
		instance = new TMSTestimonials();
		
		db = DatabaseFactory.CreateDatabase();
		sqlCommand = "[dbo].gspTMSTestimonials_SELECT";
		dbCommand = db.GetStoredProcCommand(sqlCommand, tsId);
		
		// Get results.
		ds = db.ExecuteDataSet(dbCommand);
		// Verification.
		if (ds == null || ds.Tables[0].Rows.Count == 0) throw new ApplicationException("Could not get TMSTestimonials ID:" + tsId.ToString()+ " from Database.");
		// Return results.
	...
	public void Insert(System.String tsName, System.String tsPhotopath, System.String tsTestimonials, System.DateTime? tsDate, System.Int32? tsStatus, DbTransaction transaction)
	{
		...
		db = DatabaseFactory.CreateDatabase();
		sqlCommand = "[dbo].gspTMSTestimonials_INSERT";
	...
	/// <summary>
	/// Insert current TMSTestimonials to database.
	/// </summary>
	...
	public static void Update(System.Int64? tsId, System.String tsName, System.String tsPhotopath, System.String tsTestimonials, System.DateTime? tsDate, System.Int32? tsStatus, DbTransaction transaction)
	{
		...
		db = DatabaseFactory.CreateDatabase();
		sqlCommand = "[dbo].gspTMSTestimonials_UPDATE";
	...
	public static void Delete(System.Int64? tsId, DbTransaction transaction)
	{
		...
		db = DatabaseFactory.CreateDatabase();
		sqlCommand = "[dbo].gspTMSTestimonials_DELETE";
		dbCommand = db.GetStoredProcCommand(sqlCommand, tsId);
	...
	/// <summary>
	/// Delete current TMSTestimonials from database.
	/// </summary>
	/// <param name="transaction">optional SQL Transaction</param>
	...
	#region SEARCH
	[DataObjectMethodAttribute(DataObjectMethodType.Select, false)]
	public static TMSTestimonials[] Search(System.Int64? tsId, System.String tsName, System.String tsPhotopath, System.String tsTestimonials, System.DateTime? tsDate, System.Int32? tsStatus)
	{
		DataSet ds;
		Database db;
		string sqlCommand;
		...
		ds = db.ExecuteDataSet(dbCommand);
		ds.Tables[0].TableName = TABLE_NAME;
		return TMSTestimonials.MapFrom(ds);
	}
	
	
	public static TMSTestimonials[] Search(TMSTestimonials searchObject)
	{
	...
	public static TMSTestimonials[] Search()
	{
