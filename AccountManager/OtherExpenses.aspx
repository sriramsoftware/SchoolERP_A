<%@ Page Title="" Language="C#" MasterPageFile="~/AccountManager/AccountManager.master" AutoEventWireup="true" CodeFile="OtherExpenses.aspx.cs" Inherits="AccountManager_OtherExpenses" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="maintenance_nav_wrap" style="width:557px;">
                            ...
                            <li id="tc"><a href="SchoolMaintance.aspx">Telephone</a></li>
                                ...
                                <li id="ld"><a  class="active" href="OtherExpenses.aspx">Other Expenses</a></li>                               
                                <section class="clear"></section>
                            </ul>
                         </section>
    <section class="elect_heading"> Land Building,Sports Equipment Details </section>
    <asp:Button ID="btnOtherExpense" runat="server" Text="Add Other Expense" CssClass="go"
        OnClick="btnOtherExpense_Click" />
    ...
    <asp:Button ID="btnVieW" runat="server" Text="View" CssClass="go"
        OnClick="btnVieWExpenseDetails_Click" />
    ...
    <section id="SectionMaintenanceDetails" runat="server" style="display: block;">
        ...
        EmptyDataRowStyle-VerticalAlign="Middle" EmptyDataText="No Record Found" EmptyDataRowStyle-ForeColor="Red"
                   ...
                   <asp:TemplateField HeaderText="Month" HeaderStyle-HorizontalAlign="Left">
                         ...
                         <asp:TemplateField HeaderText="Land Building" HeaderStyle-HorizontalAlign="Left">
                            <ItemTemplate>
                             <asp:LinkButton ID ="lblLandBuilding" runat ="server" OnClick ="lblLandBuildingExpense_Click" Text='<%# Bind("LandBuilding") %>' CommandArgument='<%#Eval("SPOE_Month") + ";" +Eval("SPOE_Year")%>' CommandName="LandBuilding"></asp:LinkButton>
                               <%-- <asp:Label ID="lblCanteenBill" runat="server" ></asp:Label>    --%>                            
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                        </asp:TemplateField>

                             <asp:TemplateField HeaderText="Sports Equipment" HeaderStyle-HorizontalAlign="Left">
                            <ItemTemplate>
                            <asp:LinkButton ID ="lblSportsEquipment" runat ="server" OnClick ="lblSportsEquipmentExpense_Click" Text='<%# Bind("SportsEquipment") %>' CommandArgument='<%#Eval("SPOE_Month") + ";" +Eval("SPOE_Year")%>' CommandName="SportsEquipment"></asp:LinkButton>
                         ...
                         <asp:TemplateField HeaderText="Total" HeaderStyle-HorizontalAlign="Left">
                            <ItemTemplate>
                                <asp:Label ID="lblTotal" runat="server" Text='<%# Bind("OtherExpenseTotal") %>'></asp:Label>                                
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                        </asp:TemplateField> 
                                                    ...
                                                    <ul>
                                                     <li>
                            	                         ...
                            	                         <asp:DropDownList  ID ="ddlType" runat ="server" style="float:left;" Width="220px">
                            	                          <asp:ListItem Text="Land Building" Value="LandBuilding"></asp:ListItem>
                                                           <asp:ListItem Text="Sports Equipment" Value="SpoortsEquipment"></asp:ListItem>
                            	                          </asp:DropDownList>
                                                    </li>
                                                        ...
                                                        <li>
                            	                         <label>Item Name :</label>
                            	                           <asp:TextBox ID="txtItemName" runat="server" style="float:left;" Width="220px" MaxLength="30"></asp:TextBox>
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Display="Dynamic" style="padding-left:235px" 
                                    ErrorMessage="Required" ControlToValidate="txtItemName" SetFocusOnError="true"
    ...
    <asp:Panel ID="SectionStationaryPrinting" runat="server" Style="background: #000; width: 100%;
        height: 100%; position: absolute; zoom: 1; filter: alpha(opacity=50); opacity: 1.0;
    ...
    <h1><asp:Label id="lblType" runat="server"></asp:Label>  Maintanance</h1>
                 ...
                 <asp:GridView ID="grdExpensePopUp" runat="server" AutoGenerateColumns="False" CssClass="billing_invoic" Width="98%" 
                    ...
                    EmptyDataRowStyle-ForeColor="Red"
                    EmptyDataRowStyle-HorizontalAlign="Left" CellPadding="4" GridLines="None"
                    AllowSorting="True"  AllowPaging="true" PageSize="12" ShowFooter="True">
                    <Columns>
                   <asp:TemplateField HeaderText="Sr No" HeaderStyle-HorizontalAlign="Left">
                            <ItemTemplate>
                                <asp:Label ID="lblExpensesDetailsId" runat="server" Text='<%# Bind("SPOE_DetailsId") %>' Visible="false"></asp:Label>
