...
public partial class AccountManager_OtherExpenses : System.Web.UI.Page
{
    int Total = 0;
    ...
    protected void lblLandBuildingExpense_Click(object sender, EventArgs e)
    {
        try
        {
            string Month = null;
            ...
            LinkButton lblLandBuilding = grd.FindControl("lblLandBuilding") as LinkButton;
    ...
    protected void lblSportsEquipmentExpense_Click(object sender, EventArgs e)
    {
        try
        {
            string Month = null;
            ...
            LinkButton lnk = (LinkButton)sender;
            GridViewRow grd = (GridViewRow)lnk.NamingContainer;
            LinkButton lblSportsEquipment = grd.FindControl("lblSportsEquipment") as LinkButton;
    ...
    protected void btnOtherExpense_Click(object sender, EventArgs e)
    {
        try
        {
            dvMsg.Visible = false;
    ...
    protected void btnCancel_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.Redirect("OtherExpenses.aspx"); 
        }
        catch (Exception ex) { }
    }
